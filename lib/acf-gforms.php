  ...
  class acf_field_gravity_forms extends acf_field {
    ...
    */
    ...
    function __construct() {
      ...
      if( !class_exists('acf') ) {
        trigger_error("Unable to load class ACF, activate ACF or disable the acf-gforms class", E_USER_WARNING);
        return;
      }
      // Make sure Gravity Forms is active...
      if (! class_exists('gfcommon')) {
        trigger_error("Unable to load class gfcommon, activate Gravity Forms or disable the acf-gforms class", E_USER_WARNING);
        return;
      }
